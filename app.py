...
from telegram.ext import (
    ...
    ContextTypes, JobQueue, MessageHandler, filters, ChatJoinRequestHandler  # <<< ADICIONADO
)
...
async def run_start_flow(context: ContextTypes.DEFAULT_TYPE, chat_id: int, first_name: str | None = None):
...
def main():
    ...
    log.info("🤖 Bot unificado rodando: RequestToJoin + VIP + validação do print (OpenAI).")
