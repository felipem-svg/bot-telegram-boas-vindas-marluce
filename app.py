    ...
    # ====== Vídeos (ENV com FILE_ID_VIDEO# ou cache) ======
    ...
    # ====== Capturas para salvar file_ids rapidamente ======
    ...
    # ====== OpenAI validação do print (no mesmo app) ======
    def _to_data_url(raw: bytes) -> str:
        img = Image.open(io.BytesIO(raw))
        if img.mode in ("P","RGBA"): img = img.convert("RGB")
...
- Resultado: Aprovado/Reprovado (explique motivo se reprovar)."
    ...
    # Recebe print (foto/doc) -> valida aqui mesmo
    ...
    def main():
        ...
        # mídia utilitária (captura de file_ids)
        ...
        # foto/doc para validação quando aguardando print
